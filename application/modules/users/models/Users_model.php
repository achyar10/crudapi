...
class Users_model extends CI_Model {
    ...
    function get($params = array()) {
        ...
        if (isset($params['role'])) {
            $this->db->where('role_role_id', $params['role']);
        }
        ...
        $this->db->select('user_id, user_password, user_full_name, user_token,
            user_email, user_status, user_last_login, user_input_date, user_last_update');
        $this->db->select('role_role_id, roles.role_name');

        $this->db->join('roles', 'roles.role_id = users.role_role_id', 'left');
    ...
    function add($data = array()) {
        ...
        if (isset($data['role_role_id'])) {
            $this->db->set('role_role_id', $data['role_role_id']);
        }
