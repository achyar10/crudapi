					...
					<div class="col-md-9">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="radio">
									<label>
										<input type="radio" name="user_merchant_status" value="1" <?php echo ($inputStatusValue==1) ? 'checked' : '' ?> > Active
									</label> &nbsp;&nbsp;&nbsp;
									<label>
										<input type="radio" name="user_merchant_status" value="0" <?php echo ($inputStatusValue==0) ? 'checked' : '' ?> > Not Active
									</label>
								</div>
							</div>
							<div class="mt-3">
								<button type="submit" class="btn btn-success btn-block">Save</button>
								<a href="<?php echo site_url('merchant/branch/view/'.$user_merchant['branch_branch_id']) ?>" class="btn btn-dark btn-block">Cancel</a>
							</div>
						</div>
					</form>
				</div>
